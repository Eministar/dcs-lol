...
const translations: Translations = {
    de: {
        ...
        sortFavorites: "Beliebteste",
        all: "Alle",
        noServersFound: "Keine Server gefunden",
        noServersYet: "Noch keine Server vorhanden",
        description: "Beschreibung",
        dcsLink: "DCS.lol Link",
